...
| [**AGENT_WORKFLOW.md**](./AGENT_WORKFLOW.md) | LLM provider abstraction, structured tool calls, execution lifecycle & risk hooks | Pending Specification |
...
| [**DECISIONS.md**](./DECISIONS.md) | Architecture Decision Records (ADRs) tracking trade-offs and design rationale | Pending Specification |
